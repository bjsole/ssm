...
<div class="page-header">
    <h1>添加商品<span style="color:red;">${picInfo}</span></h1>
        ...
        <tr class="warning">
            ...
            <td>
                <div class="form-group">
                    <textarea id="description" required style="resize: none" name="description" class="form-control" rows="3" placeholder="请输入商品描述"></textarea>
                </div>
            </td>
        </tr>
        <tr class="info">
            ...
            <td>
                ...
                <div class="form-group">
                    ...
                    <%--<span style="color:red;">${picInfo}</span>--%>
                </div>
            </td>
        </tr>
        <tr class="danger">
