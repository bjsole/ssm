...
<form id="user" action="" method="post">
    <div class="form-group">
        <span id="loginIfo" style="color:red;margin-left: 50px;"></span>
    </div>
    <div class="form-group">
    ...
    &nbsp;&nbsp;&nbsp;
    <button onclick="location.href = '${pageContext.request.contextPath}/user/register-ui'" class="btn btn-primary">注册账号</button>
</form>
